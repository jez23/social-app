...
const PrivacyPolicy = () => {
  return (
    <div className="center80">
      <PageTitleBar title="Privacy Policy" />
      <div>
        <h3>Your privacy is critically important to us.</h3>
        <p>
          It is Urbacise’s policy to respect your privacy regarding any
          information we may collect while operating our website. This Privacy
          Policy applies to https://www.urbacise.com (hereinafter, “us”, “we”,
          or “https://www.urbacise.com”). We respect your privacy and are
        ...
        <p>
          Like most website operators, Urbacise collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. Urbacise’s purpose in collecting non-personally
          identifying information is to better understand how Urbacise’s
          visitors use its website. From time to time, Urbacise may release
          non-personally-identifying information in the aggregate, e.g., by
          publishing a report on trends in the usage of its website.
        </p>
        <p>
          Urbacise also collects potentially personally-identifying information
          like Internet Protocol (IP) addresses for logged in users and for
          users leaving comments on https://www.urbacise.com blog posts.
          Urbacise only discloses logged in user and commenter IP addresses
          under the same circumstances that it uses and discloses
          personally-identifying information as described below.
        </p>
        <h3>Gathering of Personally-Identifying Information</h3>
        <p>
          Certain visitors to Urbacise’s websites choose to interact with
          Urbacise in ways that require Urbacise to gather
          personally-identifying information. The amount and type of information
          that Urbacise gathers depend on the nature of the interaction. For
          example, we ask visitors who sign up for a blog at
          https://www.urbacise.com to provide a username and email address.
        </p>
        <h3>Security</h3>
        <p>
        ...
        <p>
          ...
          Urbacise and does not cover the use of cookies by any advertisers.
        </p>
        ...
        <p>
          Urbacise discloses potentially personally-identifying and
          personally-identifying information only to those of its employees,
          contractors and affiliated organizations that (i) need to know that
          information in order to process it on Urbacise’s behalf or to provide
          services available at Urbacise’s website, and (ii) that have agreed
          ...
          by using Urbacise’s website, you consent to the transfer of such
          information to them. Urbacise will not rent or sell potentially
          ...
          organizations, as described above, Urbacise discloses potentially
          ...
          when Urbacise believes in good faith that disclosure is reasonably
          necessary to protect the property or rights of Urbacise, third parties
          or the public at large.
        </p>
        <p>
          If you are a registered user of https://www.urbacise.com and have
          supplied your email address, Urbacise may occasionally send you an
          email to tell you about new features, solicit your feedback, or just
          keep you up to date with what’s going on with Urbacise and our
          ...
          other users. Urbacise takes all measures reasonably necessary to
        ...
        <p>
          Urbacise may collect statistics about the behaviour of visitors to its
          website. Urbacise may display this information publicly or provide it
          to others. However, Urbacise does not disclose your
          personally-identifying information.
        </p>
        ...
        <h3>Cookies</h3>
        <p>
          To enrich and perfect your online experience, Urbacise uses “Cookies”,
        ...
        <p>
          ...
          website each time the visitor returns. Urbacise uses cookies to help
          Urbacise identify and track visitors, their usage of
          https://www.urbacise.com, and their website access preferences.
          Urbacise visitors who do not wish to have cookies placed on their
          computers should set their browsers to refuse cookies before using
          Urbacise’s websites, with the drawback that certain features of
          Urbacise’s websites may not function properly without the aid of
          cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to Urbacise’s use of
          cookies.
        </p>
        <p>For more information on cookies, please read our Cookie Policy.</p>
        <h3>E-commerce</h3>
        <p>
          Those who engage in transactions with Urbacise – by purchasing
          Urbacise’s services or products, are asked to provide additional
          ...
          Urbacise collects such information only insofar as is necessary or
          appropriate to fulfil the purpose of the visitor’s interaction with
          Urbacise. Urbacise does not disclose personally-identifying
        ...
        <p>
          Although most changes are likely to be minor, Urbacise may change its
          Privacy Policy from time to time, and in Urbacise’s sole discretion.
          Urbacise encourages visitors to frequently check this page for any
